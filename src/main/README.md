...
### Feature: Character Has Ability Scores

As a character I want to have several abilities so that I am not identical to other characters except in name

- Ability are Strength, Dexterity, Constitution, Wisdom, Intelligence, Charisma
- Ability range from 1 to 20 and default to 10
- Ability have modifiers according to the following table:
